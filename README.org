...
Declarative system configuration and totally reproducible builds are the future
in the enterprise and in personal configurations. These are my two cents, and
this is my configuration for Nix, the package manager (and the DSL used by it)
that promises both of them.
